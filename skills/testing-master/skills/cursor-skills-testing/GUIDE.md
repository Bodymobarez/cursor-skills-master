---
name: cursor-skills-testing
description: Testing rules for Cursor — unit, integration, E2E, performance testing, Jest, Cypress, and test automation. Use when writing or setting up tests.
---
