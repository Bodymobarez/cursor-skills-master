...
description: Migrate CSS Modules (.module.css/.module.scss) to Tailwind v4 utility classes. Handles styles object removal, className interpolation, composition, and global overrides. Use tailwind-v4-latest in tailwind-master for @theme setup.
user-invocable: true
---
