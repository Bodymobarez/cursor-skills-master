---
name: cursor-skills-general
description: General Cursor IDE best practices — project structure, code quality, workflow, extensions, and universal development guidelines. Use for any Cursor project setup or cross-language conventions.
---
...
- Extended guide: [reference-master.md](reference-master.md)

## Bundled resources

Source: [araguaci/cursor-skills](https://github.com/araguaci/cursor-skills) · [cursor-skills.vercel.app](https://cursor-skills.vercel.app/)
- Extended guide: [reference-master-guide.md](reference-master-guide.md)
- VS Code configs: `configs/`
