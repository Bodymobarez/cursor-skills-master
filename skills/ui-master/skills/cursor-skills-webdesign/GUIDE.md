...
description: Web design and frontend rules for Cursor — HTML, CSS, JavaScript, React, Vue, Angular, responsive design, and accessibility. Use for frontend or web design work.
---
...
- Extended guide: [reference-web_design.md](reference-web_design.md)
...
- Domain README (PT): [README.md](README.md)
- Templates: `templates/`
- Examples: `examples/`
