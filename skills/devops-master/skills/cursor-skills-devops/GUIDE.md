---
name: cursor-skills-devops
description: DevOps rules for Cursor — Docker, Kubernetes, CI/CD, monitoring, and cloud deployment. Use for infrastructure and DevOps tasks.
---
...
- Extended guide: [reference-devops.md](reference-devops.md)
