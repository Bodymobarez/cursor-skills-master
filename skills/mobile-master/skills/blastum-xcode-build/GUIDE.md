...
- **[CLI Reference](CLI_REFERENCE.md)** - Complete xcodebuild command reference and options
- **[XCUITest Guide](XCUITEST_GUIDE.md)** - UI testing patterns, automation examples, and best practices
