...
description: Python development rules for Cursor — Django, Flask, FastAPI, data science, virtual environments, and testing. Use when working with Python projects.
---
...
- Extended guide: [reference-python.md](reference-python.md)
