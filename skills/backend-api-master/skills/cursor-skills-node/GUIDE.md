...
description: Node.js development rules for Cursor — Express, NestJS, Next.js, npm, TypeScript, and async patterns. Use for Node.js or JavaScript backend work.
---
...
- Extended guide: [reference-nodejs.md](reference-nodejs.md)
