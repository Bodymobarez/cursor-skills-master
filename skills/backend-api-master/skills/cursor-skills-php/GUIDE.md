...
description: PHP development rules for Cursor — Laravel, Symfony, WordPress, Composer, and PHP project structure. Use when working with PHP, Laravel, Symfony, or WordPress.
---
