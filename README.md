...
|--------|:--:|----------------|
| `ui-master` | 23 | UI, frontend, design systems, **brand identity**, **charts & dashboards**, **Figma-grade design systems**, **ultra-HD/8K-crisp rendering**, **award-winning effects (WebGL/3D/motion)**, CSS→Tailwind, responsive/a11y |
