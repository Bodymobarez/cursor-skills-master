...
A curated, **organized** collection of **258 advanced agent skills** for [Cursor](https://cursor.com), bundled into **16 master "hub" skills** — one per domain.
...
|--------|:--:|----------------|
| `ui-master` | 18 | UI, frontend, design systems, CSS→Tailwind, responsive/dark-mode/a11y testing |
...
| `documents-master` | 16 | DOCX, PDF, PPTX, XLSX, Markdown, diagrams, image generation |
...
| `ai-mcp-master` | 10 | MCP server building, prompt engineering/optimization, model APIs |
...
**Total: 258 bundled skills across 16 masters.**
